...
export default {
  ...
  async fetchNewArticles() {
    const response = await axios.get('api/sources/fetch')
    return response.data
  },
  ...
  async updateSourceActive(item, bool) {
    const response = await axios.put(`api/sources/${item._id}`, {
      active: bool,
    })
    return response.data
  },
  ...
  async updateCollectionActive(item, bool) {
    const response = await axios.put(`api/collections/${item._id}`, {
      active: bool,
    })
    return response.data
  },
