    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
      ...
      <ul>
        ...
        <li class="relative px-6 py-3">
          <div class="relative w-full mr-6 focus-within:text-yellow-500">
        ...
        <li class="relative px-6 py-1">
          <p
            class="inline-flex items-center w-full text-sm font-semibold text-gray-400"
          >
            Sources
          </p>
        </li>
        <li
          class="flex relative px-6 py-1"
        ...
        >
          ...
          ></span>
          <div
            class="w-full text-sm font-semibold text-gray-500 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
          >
            {{ source.title }}
          </div>
